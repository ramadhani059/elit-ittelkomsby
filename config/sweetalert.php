...
return [
    ...
    */
    ...
    'customClass' => [
        ...
        'popup' => env('SWEET_ALERT_POPUP_CLASS', 'bg-light'),
        ...
        'confirmButton' => env('SWEET_ALERT_CONFIRM_BUTTON_CLASS', 'bg-primary'),
        'cancelButton' => env('SWEET_ALERT_CANCEL_BUTTON_CLASS', 'bg-danger'),
