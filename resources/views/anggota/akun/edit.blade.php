  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card mb-4">
        ...
        <!-- Account -->
        <form action="{{ route('updatemyanggotaprofile', ['id' => Auth::user()->id]) }}" method="POST" enctype="multipart/form-data" id="registerForm">
        @csrf
        @method('put')
            <div class="card-body">
            ...
            <div class="card-body">
                ...
                <div class="mt-4">
                    <div class="row">
                        ...
                        <div class="d-grid gap-2 col-lg-6 mx-auto">
                            <a class="btn btn-danger btn-lg text-white" type="button" href="{{ route('myprofileanggota') }}">Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
