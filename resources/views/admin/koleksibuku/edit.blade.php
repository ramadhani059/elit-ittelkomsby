...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row align-items-center d-flex media py-4">
        <div class="col-lg-6 col-12 media-body d-none d-lg-block f-grow-1">
            <h5 class="fw-bold"><span class="text-muted fw-light">Katalog Buku/ Koleksi Buku/</span> Edit Koleksi Buku</h5>
        </div>
    </div>
    ...
    <div class="col-xxl">
        <div class="card mb-4">
          <div class="card-body">
            <form action="{{ route('koleksi-buku.update', ['koleksi_buku' => $koleksibuku->id]) }}" method="POST" enctype="multipart/form-data" id="katalogForm">
              @csrf
              @method('put')
              <div class="row">
