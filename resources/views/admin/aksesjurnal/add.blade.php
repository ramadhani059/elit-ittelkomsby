...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card mb-4">
        <!-- Account -->
        <form action="{{ route('akses-jurnal.store') }}" method="POST" enctype="multipart/form-data" id="AksesJurnalForm">
        @csrf
            <div class="card-body">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-select kategoriaksesjurnal @error('kategoriaksesjurnal') is-invalid @enderror" id="kategoriaksesjurnal" name="kategoriaksesjurnal">
                            ...
                            @foreach($kategori as $category)
                                <option value="{{ $category }}" {{ old('kategoriaksesjurnal') == $category ? 'selected' : '' }}>{{ $category }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div id="defaultFormControlHelp" class="form-text text-danger">
